...
libaccess_la_DEPENDENCIES = libdiskio.la libs/libcfu/src/libcfu.la \
	libutility.la
am_libaccess_la_OBJECTS = sqlaccess.lo
libaccess_la_OBJECTS = $(am_libaccess_la_OBJECTS)
libbtree_la_LIBADD =
am_libbtree_la_OBJECTS = btree.lo
libbtree_la_OBJECTS = $(am_libbtree_la_OBJECTS)
libcheck_la_DEPENDENCIES = libaccess.la libutility.la
am_libcheck_la_OBJECTS = check_utility.lo
libcheck_la_OBJECTS = $(am_libcheck_la_OBJECTS)
libclient_la_DEPENDENCIES = libs/libcfu/src/libcfu.la libutility.la
am_libclient_la_OBJECTS = sql_client.lo
libclient_la_OBJECTS = $(am_libclient_la_OBJECTS)
libdiskio_la_DEPENDENCIES = libbtree.la libutility.la
am_libdiskio_la_OBJECTS = diskio.lo
libdiskio_la_OBJECTS = $(am_libdiskio_la_OBJECTS)
libparser_la_DEPENDENCIES = libaccess.la libutility.la
am_libparser_la_OBJECTS = sql_parser.lo
libparser_la_OBJECTS = $(am_libparser_la_OBJECTS)
libserver_la_DEPENDENCIES = libaccess.la libutility.la
...
check_access_DEPENDENCIES = $(am__DEPENDENCIES_1) \
	...
	$(top_builddir)/libcheck.la $(top_builddir)/libutility.la
...
check_sql_client_DEPENDENCIES = $(am__DEPENDENCIES_1) \
	$(top_builddir)/libclient.la $(top_builddir)/libutility.la
...
am_sqlserver_OBJECTS = sqlserver.$(OBJEXT)
sqlserver_OBJECTS = $(am_sqlserver_OBJECTS)
sqlserver_DEPENDENCIES = libserver.la libdiskio.la \
	libs/libcfu/src/libcfu.la
DEFAULT_INCLUDES = -I.
...
SOURCES = $(libaccess_la_SOURCES) $(libbtree_la_SOURCES) \
	...
	$(libserver_la_SOURCES) $(libutility_la_SOURCES) \
	$(check_access_SOURCES) $(check_commit_SOURCES) \
	$(check_sql_client_SOURCES) $(check_sql_parser_SOURCES) \
	$(check_storage_SOURCES) $(sqlclient_SOURCES) \
	$(sqlserver_SOURCES)
...
ACLOCAL = ${SHELL} /home/notroot/projects/sql-database/build-aux/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /home/notroot/projects/sql-database/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /home/notroot/projects/sql-database/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /home/notroot/projects/sql-database/build-aux/missing --run automake-1.11
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/notroot/projects/sql-database/build-aux/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
PACKAGE = 
PACKAGE_BUGREPORT = 
PACKAGE_NAME = SQL-DATABASE
PACKAGE_STRING = SQL-DATABASE 0.1
PACKAGE_TARNAME = sql-database
PACKAGE_URL = 
PACKAGE_VERSION = 0.1
PATH_SEPARATOR = :
...
abs_top_builddir = /home/notroot/projects/sql-database
abs_top_srcdir = /home/notroot/projects/sql-database
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/notroot/projects/sql-database/build-aux/install-sh
...
check_sql_client_LDADD = ${check_LIBS} $(top_builddir)/libclient.la $(top_builddir)/libutility.la -lcheck
check_storage_SOURCES = tests/check_storage.c src/server/storage/diskio.h
check_storage_CFLAGS = ${check_CFLAGS}
check_storage_LDADD = ${check_LIBS} $(top_builddir)/libdiskio.la $(top_builddir)/libbtree.la $(top_builddir)/libutility.la -lcheck
...
check_access_LDADD = ${check_LIBS} $(top_builddir)/libaccess.la $(top_builddir)/libbtree.la $(top_builddir)/libdiskio.la $(top_builddir)/libs/libcfu/src/libcfu.la $(top_builddir)/libcheck.la $(top_builddir)/libutility.la -lcheck
...
check_commit_LDADD = ${check_LIBS} $(top_builddir)/libaccess.la $(top_builddir)/libbtree.la $(top_builddir)/libdiskio.la $(top_builddir)/libs/libcfu/src/libcfu.la $(top_builddir)/libcheck.la $(top_builddir)/libutility.la -lcheck
...
libaccess.la: $(libaccess_la_OBJECTS) $(libaccess_la_DEPENDENCIES) $(EXTRA_libaccess_la_DEPENDENCIES) 
	$(LINK) -rpath $(libdir) $(libaccess_la_OBJECTS) $(libaccess_la_LIBADD) $(LIBS)
libbtree.la: $(libbtree_la_OBJECTS) $(libbtree_la_DEPENDENCIES) $(EXTRA_libbtree_la_DEPENDENCIES) 
	$(LINK) -rpath $(libdir) $(libbtree_la_OBJECTS) $(libbtree_la_LIBADD) $(LIBS)
libcheck.la: $(libcheck_la_OBJECTS) $(libcheck_la_DEPENDENCIES) $(EXTRA_libcheck_la_DEPENDENCIES) 
	$(LINK) -rpath $(libdir) $(libcheck_la_OBJECTS) $(libcheck_la_LIBADD) $(LIBS)
...
libutility.la: $(libutility_la_OBJECTS) $(libutility_la_DEPENDENCIES) $(EXTRA_libutility_la_DEPENDENCIES) 
	$(LINK) -rpath $(libdir) $(libutility_la_OBJECTS) $(libutility_la_LIBADD) $(LIBS)
...
sqlserver$(EXEEXT): $(sqlserver_OBJECTS) $(sqlserver_DEPENDENCIES) $(EXTRA_sqlserver_DEPENDENCIES) 
	@rm -f sqlserver$(EXEEXT)
	$(LINK) $(sqlserver_OBJECTS) $(sqlserver_LDADD) $(LIBS)
...
sqlaccess.lo: src/server/access/sqlaccess.c
	$(LIBTOOL)  --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT sqlaccess.lo -MD -MP -MF $(DEPDIR)/sqlaccess.Tpo -c -o sqlaccess.lo `test -f 'src/server/access/sqlaccess.c' || echo '$(srcdir)/'`src/server/access/sqlaccess.c
	$(am__mv) $(DEPDIR)/sqlaccess.Tpo $(DEPDIR)/sqlaccess.Plo
#	source='src/server/access/sqlaccess.c' object='sqlaccess.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(LIBTOOL)  --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o sqlaccess.lo `test -f 'src/server/access/sqlaccess.c' || echo '$(srcdir)/'`src/server/access/sqlaccess.c

btree.lo: libs/libbtree/btree.c
	$(LIBTOOL)  --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT btree.lo -MD -MP -MF $(DEPDIR)/btree.Tpo -c -o btree.lo `test -f 'libs/libbtree/btree.c' || echo '$(srcdir)/'`libs/libbtree/btree.c
	$(am__mv) $(DEPDIR)/btree.Tpo $(DEPDIR)/btree.Plo
#	source='libs/libbtree/btree.c' object='btree.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(LIBTOOL)  --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o btree.lo `test -f 'libs/libbtree/btree.c' || echo '$(srcdir)/'`libs/libbtree/btree.c

check_utility.lo: tests/check_utility.c
	$(LIBTOOL)  --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT check_utility.lo -MD -MP -MF $(DEPDIR)/check_utility.Tpo -c -o check_utility.lo `test -f 'tests/check_utility.c' || echo '$(srcdir)/'`tests/check_utility.c
	$(am__mv) $(DEPDIR)/check_utility.Tpo $(DEPDIR)/check_utility.Plo
#	source='tests/check_utility.c' object='check_utility.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(LIBTOOL)  --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o check_utility.lo `test -f 'tests/check_utility.c' || echo '$(srcdir)/'`tests/check_utility.c

sql_client.lo: src/client/sql_client.c
	$(LIBTOOL)  --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT sql_client.lo -MD -MP -MF $(DEPDIR)/sql_client.Tpo -c -o sql_client.lo `test -f 'src/client/sql_client.c' || echo '$(srcdir)/'`src/client/sql_client.c
	$(am__mv) $(DEPDIR)/sql_client.Tpo $(DEPDIR)/sql_client.Plo
...
#	source='src/server/sql_server.c' object='sql_server.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
...
utility.lo: libs/libutility/utility.c
	$(LIBTOOL)  --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT utility.lo -MD -MP -MF $(DEPDIR)/utility.Tpo -c -o utility.lo `test -f 'libs/libutility/utility.c' || echo '$(srcdir)/'`libs/libutility/utility.c
	$(am__mv) $(DEPDIR)/utility.Tpo $(DEPDIR)/utility.Plo
#	source='libs/libutility/utility.c' object='utility.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(LIBTOOL)  --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o utility.lo `test -f 'libs/libutility/utility.c' || echo '$(srcdir)/'`libs/libutility/utility.c
...
sqlclient.o: src/client/sqlclient.c
	...
	$(am__mv) $(DEPDIR)/sqlclient.Tpo $(DEPDIR)/sqlclient.Po
#	source='src/client/sqlclient.c' object='sqlclient.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o sqlclient.o `test -f 'src/client/sqlclient.c' || echo '$(srcdir)/'`src/client/sqlclient.c

sqlclient.obj: src/client/sqlclient.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT sqlclient.obj -MD -MP -MF $(DEPDIR)/sqlclient.Tpo -c -o sqlclient.obj `if test -f 'src/client/sqlclient.c'; then $(CYGPATH_W) 'src/client/sqlclient.c'; else $(CYGPATH_W) '$(srcdir)/src/client/sqlclient.c'; fi`
	$(am__mv) $(DEPDIR)/sqlclient.Tpo $(DEPDIR)/sqlclient.Po
#	source='src/client/sqlclient.c' object='sqlclient.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o sqlclient.obj `if test -f 'src/client/sqlclient.c'; then $(CYGPATH_W) 'src/client/sqlclient.c'; else $(CYGPATH_W) '$(srcdir)/src/client/sqlclient.c'; fi`

sqlserver.o: src/server/sqlserver.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT sqlserver.o -MD -MP -MF $(DEPDIR)/sqlserver.Tpo -c -o sqlserver.o `test -f 'src/server/sqlserver.c' || echo '$(srcdir)/'`src/server/sqlserver.c
	$(am__mv) $(DEPDIR)/sqlserver.Tpo $(DEPDIR)/sqlserver.Po
#	source='src/server/sqlserver.c' object='sqlserver.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o sqlserver.o `test -f 'src/server/sqlserver.c' || echo '$(srcdir)/'`src/server/sqlserver.c

sqlserver.obj: src/server/sqlserver.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT sqlserver.obj -MD -MP -MF $(DEPDIR)/sqlserver.Tpo -c -o sqlserver.obj `if test -f 'src/server/sqlserver.c'; then $(CYGPATH_W) 'src/server/sqlserver.c'; else $(CYGPATH_W) '$(srcdir)/src/server/sqlserver.c'; fi`
	$(am__mv) $(DEPDIR)/sqlserver.Tpo $(DEPDIR)/sqlserver.Po
#	source='src/server/sqlserver.c' object='sqlserver.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o sqlserver.obj `if test -f 'src/server/sqlserver.c'; then $(CYGPATH_W) 'src/server/sqlserver.c'; else $(CYGPATH_W) '$(srcdir)/src/server/sqlserver.c'; fi`
