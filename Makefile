...
am_libclient_la_OBJECTS = sql_client.lo networking.lo
libclient_la_OBJECTS = $(am_libclient_la_OBJECTS)
libserver_la_LIBADD =
am_libserver_la_OBJECTS = sql_server.lo networking.lo
...
libclient_la_SOURCES = src/client/sql_client.c src/client/sql_client.h src/networking/networking.h src/networking/networking.c
libclient_la_LIBADD = libs/libcfu/src/libcfu.la
libserver_la_SOURCES = src/server/sql_server.c src/server/sql_server.h src/networking/networking.h src/networking/networking.c 
...
networking.lo: src/networking/networking.c
	$(LIBTOOL)  --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT networking.lo -MD -MP -MF $(DEPDIR)/networking.Tpo -c -o networking.lo `test -f 'src/networking/networking.c' || echo '$(srcdir)/'`src/networking/networking.c
	$(am__mv) $(DEPDIR)/networking.Tpo $(DEPDIR)/networking.Plo
#	source='src/networking/networking.c' object='networking.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(LIBTOOL)  --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o networking.lo `test -f 'src/networking/networking.c' || echo '$(srcdir)/'`src/networking/networking.c
